    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                test = int.TryParse(Console.ReadLine(), out faltas);

            } while (test == false);

            do
            {
                Console.WriteLine("Atraso em horas");
                test = int.TryParse(Console.ReadLine(), out atrasoHoras);
            ...
            salarioResultado -= (salariob / 30) * faltas;
            salarioResultado -= (salariob / 220) * atrasoHoras;
